...
public class JFrame extends javax.swing.JFrame {
    ...
    private void CalcButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcButtonActionPerformed
        ...
        if (num%2 == 0)
            new TwoThreads("FirstThread").start();
        else
            new TwoThreads("SecondThread").start();
        ...
        if (Table.getSelectedRowCount() == 1 )
            {
                ...
                try {
                  ...
                  model.setValueAt(null,Table.getSelectedRow(),3);
                  return;
                }
            ...
            JOptionPane.showMessageDialog(null, "Выберите строку для вычисления!", "Ошибочка вышла!", JOptionPane.PLAIN_MESSAGE);
